...
# Figure S13F. Cell abundance correlation heatmap (Note that MCPcounter was used here due to its ability to estimate abundance of dendritic cells)
```{r}
...
# Figure S13G. comparison of gene IFNG and CXCL9, and GMCSF cytosig score in B-high vs B-low tumors
```{r}
...
# Figure S13G. comparison of MHCII, cross-presentation, and Hypoxia ssgsea scores in B-high vs B-low tumors
```{r}
