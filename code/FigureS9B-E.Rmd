...
# Figure S7B. compare NLR, albumin and B cell ratio AUC on Cohort11
```{r}
...
# Figure S7C. compare NLR and albumin AUC on Cohort9
```{r}
...
# Figure S7D. AUCs of individual variables and integrative models (Cohort5)
```{r}
...
# Figure S7E. AUCs of individual variables and integrative models (Cohort11)
```{r}
