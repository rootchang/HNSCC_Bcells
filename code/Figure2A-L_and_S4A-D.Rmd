...
# Figure 2CD - Figure S4AB. OS/PFS K-M curves for TCGA-HNC
```{r}
...
# Figure 2GH (Bcell_high_vs_low_cutoff = 0.5) and Figure S4CD (Bcell_high_vs_low_cutoff = 0.333). OS/PFS K-M curves for merged HNSCC Cohorts2-4 
```{r}
