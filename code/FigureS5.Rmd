...
# Fig. S4B. forest plot of B with clinical vars (HPV, age, sex, stage)
```{r}
...
# Fig. S4C. K-M OS curves for four groups (Bratio and HPV)
```{r}
...
# Fig. S4D. barplot of SCC correlation and p values between Bratio and TLS_sig/CD8A/IFNG_sig/CXCL9_SPP1/Tcells...
```{r}
...
# Fig. S4E. forest plot for TLS_sig/CD8A/IFNG_sig/CXCL9_SPP1/Tcells MHRs controlling (HPV, age, sex, stage)
```{r}
