...
# Figure S13A-D. correlation plot between Bratio and signatures
```{r}
...
# Figure S13E. heatmap of CXCL9, IFNG, and GM-CSF cytosig vs B cell abundance among HPVp, HPVn, and merged patients
```{r}
