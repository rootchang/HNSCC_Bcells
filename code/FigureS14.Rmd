...
# Figure S12. correlation network between abundance of different cells in tumor (Note that MCPcounter was used here due to its ability to estimate abundance of dendritic cells)
```{r}
